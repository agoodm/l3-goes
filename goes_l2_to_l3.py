...
dsm = ds.where(mask).mean('t').stack(grid=['y', 'x']).reset_index('grid')
...
ds_out.good_pixel_count.attrs['description'] = 'Number of geostationary projection pixels where DQF_Overall is 0'
